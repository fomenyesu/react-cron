...
class CRON extends React.Component {
  constructor(props) {
    ...
    const values =
      value && value !== "" && cronValidate(value) ? value : "0 0 0 * * ?";
    ...
    if (week === "*") {
      ...
      weekRadiochecked = 4;
      [weekStart, weekEvery] = week.split("#").reverse();
  ...
  onSecondRadioChange = e => {
    ...
    switch (SecondRadiochecked) {
      ...
      case 2:
        this.changeState({
          secondVal: `${this.state.secondCycleStart}-${this.state.secondCycleEnd}`
        });
        break;
      case 3:
        this.changeState({
          secondVal: `${this.state.secondStart}/${this.state.secondEvery}`
        });
        break;
      case 4:
  ...
  onSecndcheckChange = checkedValues => {
    const secondChecked =
      checkedValues.length > 0 ? checkedValues.join(",") : "0";
  ...
  onMinuteRadioChange = e => {
    ...
    switch (minuteRadiochecked) {
      ...
      case 2:
        this.changeState({
          minVal: `${this.state.minuteCycleStart}-${this.state.minuteCycleEnd}`
        });
        break;
      case 3:
        this.changeState({
          minVal: `${this.state.minuteStart}/${this.state.minuteEvery}`
        });
        break;
      case 4:
  ...
  onHourRadioChange = e => {
    ...
    switch (hourRadiochecked) {
      ...
      case 2:
        this.changeState({
          hourVal: `${this.state.hourCycleStart}-${this.state.hourCycleEnd}`
        });
        break;
      case 3:
        this.changeState({
          hourVal: `${this.state.hourStart}/${this.state.hourEvery}`
        });
        break;
      case 4:
  ...
  onDaysRadioChange = e => {
    ...
    switch (daysRadiochecked) {
      ...
      case 3:
        this.changeState({
          dayOfMonVal: `${this.state.daysCycleStart}-${this.state.daysCycleEnd}`
        });
        break;
      case 4:
        this.changeState({
          dayOfMonVal: `${this.state.daysStart}/${this.state.daysEvery}`
        });
        break;
      case 5:
  ...
  daysCycleEnd = value => {
    ...
    if (this.state.daysRadiochecked == 3) {
      this.changeState({
        dayOfMonVal: `${this.state.daysCycleStart}-${value}`
      });
    }
  };
  // CRON-日-指定从多少开始
  ...
  onDaysCheckChange = checkedValues => {
    const daysChecked =
      checkedValues.length > 0 ? checkedValues.join(",") : "1";
  ...
  onMonthRadioChange = e => {
    ...
    switch (monthRadiochecked) {
      ...
      case 3:
        this.changeState({
          MonVal: `${this.state.monthCycleStart}-${this.state.monthCycleEnd}`
        });
        break;
      case 4:
        this.changeState({
          MonVal: `${this.state.monthStart}/${this.state.monthEvery}`
        });
        break;
      case 5:
  ...
  onWeekRadioChange = e => {
    ...
    switch (weekRadiochecked) {
      ...
      case 3:
        this.changeState({
          dayOfWekVal: `${this.state.weekCycleStart}-${this.state.weekCycleEnd}`
        });
        break;
      case 4:
        this.changeState({
          dayOfWekVal: `${this.state.weekEvery}#${this.state.weekStart}`
        });
        break;
      case 5:
  ...
  weekCycleEnd = value => {
    ...
    if (this.state.weekRadiochecked === 3) {
      this.changeState({
        dayOfWekVal: `${this.state.weekCycleStart}-${value}`
      });
    }
  };
  // CRON-周-指定该月的第几周
  ...
  onWeekCheckChange = checkedValues => {
    const weekChecked =
      checkedValues.length > 0 ? checkedValues.join(",") : "MON";
  ...
  onYearRadioChange = e => {
    ...
    switch (yearRadiochecked) {
      ...
      case 3:
        this.setState({
          yearVal: `${this.state.yearCycleStart}-${this.state.yearCycleEnd}`
        });
        break;
    }
  ...
  yearCycleStart = e => {
    if (this.state.yearRadiochecked == 3) {
      this.setState({
        yearVal: `${e.target.value}-${this.state.yearCycleEnd}`
      });
    }
  ...
  yearCycleEnd = e => {
    if (this.state.yearRadiochecked == 3) {
      this.setState({
        yearVal: `${this.state.yearCycleStart}-${e.target.value}`
      });
    }
              ...
              <RadioGroup
                ...
                <Radio style={radioStyle} value={4}>
                  ...
                  <CheckboxGroup
                    ...
                    <Row>
                      {" "}
                      {this.createChecks(options, SecondRadiochecked, 4)}{" "}
                    </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
              ...
              <RadioGroup
                ...
                <Radio style={radioStyle} value={4}>
                  ...
                  <CheckboxGroup
                    ...
                    <Row>
                      {" "}
                      {this.createChecks(options, minuteRadiochecked, 4)}{" "}
                    </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
              ...
              <RadioGroup
                ...
                <Radio style={radioStyle} value={4}>
                  ...
                  <CheckboxGroup
                    ...
                    <Row>
                      {" "}
                      {this.createChecks(hourOptions, hourRadiochecked, 4)}{" "}
                    </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
              ...
              <RadioGroup
                ...
                <Radio style={radioStyle} value={6}>
                  ...
                  <CheckboxGroup
                    ...
                    <Row>
                      {" "}
                      {this.createChecks(weekOptions, weekRadiochecked, 6)}{" "}
                    </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
